<template>
	<div>
		...
		<el-dialog title="PDF预览" :visible.sync="show" width="70%" center destroy-on-close>
			<el-scrollbar class="scrollbar" style="height: 70vh">
				<!-- 此处修复了Promise.all 第二次不执行 -->
				<div v-if="show">
			...
			<span slot="footer" class="dialog-footer">
				...
				<el-button type="primary" @click="createPDF" :loading="lodDisabled">下 载</el-button>
			</span>
		</el-dialog>
	</div>
</template>
